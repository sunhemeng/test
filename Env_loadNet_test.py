...
model = QN.load_weights(sim_env.channel_type + '_MA-raw-results_Weights_DDPG_S{}_rho{}_SNR{}_PS{}_lr5e-05_df0.0_W4_sigOU0.8_thetaOU0.5_Critic_LR_weights_actor_h5'.format(sim_env.S, sim_env.p,
                                                                                            sim_env.SNR_avg[0],
                                                                                            sim_env.pi),
                sim_env.channel_type + '_MA-raw-results_Weights_DDPG_S{}_rho{}_SNR{}_PS{}_lr5e-05_df0.0_W4_sigOU0.8_thetaOU0.5_Critic_LR_weights_critic_h5'.format(sim_env.S, sim_env.p,
                                                                                             sim_env.SNR_avg[0],
                                                                                             sim_env.pi))
